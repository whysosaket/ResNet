...
const IncomingMessage = (props) => {
  return (
    <>
        {props.message.length>0&&<motion.div initial={{x: -30, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{delay: 0.5, duration: 0.3}} className='flex justify-start items-center my-2'>
